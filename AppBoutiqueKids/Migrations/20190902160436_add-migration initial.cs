        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippDate = table.Column<DateTime>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SupplierShipperId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Supplier_Shipper", x => x.SupplierShipperId);
                    table.ForeignKey(
                        name: "FK_Supplier_Shipper_Shippers_ShipperId",
                        column: x => x.ShipperId,
                        principalTable: "Shippers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Supplier_Shipper_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SupplierProductsId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ProductId = table.Column<int>(nullable: false),
                    SupplierId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Supplier_Products", x => x.SupplierProductsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Supplier_Shipper_ShipperId",
                table: "Supplier_Shipper",
                column: "ShipperId");

            migrationBuilder.CreateIndex(
                name: "IX_Supplier_Shipper_SupplierId",
                table: "Supplier_Shipper",
                column: "SupplierId");
        }
